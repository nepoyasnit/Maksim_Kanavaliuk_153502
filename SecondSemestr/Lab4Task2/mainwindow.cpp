...
int* MainWindow::getObjsAndVarsData()
{
    classes_names.clear();
    arrays_names.clear();
    objects_names.clear();
...
void MainWindow::showObjsAndVarsData(int* nums)
{
    spare = "";
...
{
    QString path = QFileDialog::getOpenFileName(this,"Open","D:\\Desktop\\qt\\NewParser","Cpp file (*.cpp)");
    QFile file(path);
...
void MainWindow::on_comboBox_currentIndexChanged(int index)
{
    ...
    case 1: showObjsAndVarsData(getObjsAndVarsData()); break;
